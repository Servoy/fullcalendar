...
//        }
//        if (seg.isStart) {
//            classes.push('fc-corner-start');
//        }
//        if (seg.isEnd) {
//            classes.push('fc-corner-end');
//        }
...
function AgendaView(element, calendar, viewName) {
	...
	function buildDayTable() {
		...
		// @author paronne: merge with fullcalendar when will be implemented
...
//					}
	...
	//send undefined resource param 
	function reportDayRightClick(date, allDay, ev) {
		trigger('dayRightClick', dayBodyCells[dateToCell(date).col], date, allDay, ev, undefined);
	}	
...
function DayEventRenderer() {
	...
	function _renderDayEvents(events, doAppend, doRowHeights, resources) {
		...
		//PA fix
		if(resources) {
			segments = compileResourceSegments(segments, resources);
		}
		var html;
		var elements;
...
/*PA
 * in resourceView adjust che segments */
function compileResourceSegments(segments, resources) {
